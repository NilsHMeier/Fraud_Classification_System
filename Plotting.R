...
draw_confusion_matrix <- function(cm) {
  # Code from: https://stackoverflow.com/questions/23891140/r-how-to-visualize-confusion-matrix-using-the-caret-package/42940553
  ...
  text(140, 400, 'No Fraud', cex=1.2, srt=90)
